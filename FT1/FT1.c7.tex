...
\notamargen{Esto formaba parte de una clase que tenía el comienzo perdido.}
La cuadridensidad de fuerza de Lorentz, un cuadrivector que proviene de una contracción
\be
	f^\beta = \frac{1}{4\pi} F^{\mu\beta} \partial^\alpha F_{\alpha\beta} = 
...
\notamargen{Acá deberíamos enfatizar lo importante que es tratar de enfatizar que las
simetrías de los entes se reflejen en la escritura de las contracciones. Luego resulta
más fácil saber cuando la cosa aporta o no lo hace.}
\[
	= \frac{1}{8\pi} \left( 
	 \frac{1}{2} F_{\nu\lambda}\partial^\nu F^{\lambda\b} 
	+ \frac{1}{2} F_{\mu\nu}\partial^\mu F^{\nu\b} 
...
\begin{figure}[htb]
	\begin{center}
	\includegraphics[width=0.3\textwidth]{images/fig_ft1_4vel.pdf}	 
	\end{center}
	\caption{}
\end{figure} 
...
\notamargen{Ahora estamos en el mismo sistema coordenado y las expresiones
pueden igualarse tranquilamente.}
