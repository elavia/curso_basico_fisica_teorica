...
\]
\notamargen{Parece haber un error en el despeje. Copio la carpeta tal cual. Veremos.}
que es la Eq. 2.
La solución será
\[
...
\notamargen{Tomé la siguiente nota que pego aquí:
\includegraphics[width=0.3\textwidth]{images/fig_ft1_problema9D_medios.jpg} 
}
