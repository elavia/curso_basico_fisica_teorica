...
La traslación rígida implica que 
\[
	\dpar{\vb{v}_i}{\dot{q}} = \dpar{\vb{x}_i}{q} = 
	\lim_{\delta q \to 0} \frac{\vb{x}_i + \delta q \:\hat{n} -\vb{x}_i}{\delta q} = \hat{n}.
\]
\notamargen{Poner nota de cómo se llega a esta expresión; una chain rule un poco abuso de notación.
$\dpar{x}{q} = \dtot{x}{q} 1/\dot{q}$.}
de modo que 
\[
