...
\]
y se requiere que sigan valiendo las ecuaciones \eqref{el-pot-x}, necesitaremos evidentemente
\[
	Q_j = \dtot{}{t} \left( \dpar{U}{\dot{q}_j} \right)  -\dpar{U}{q_j},
\]
una fuerza generalizada que depende de posición y velocidad.

El ejemplo canónico de una tal fuerza es la fuerza de Lorentz que sufre una partícula de carga $q$ en
...
De esta manera, \eqref{f_lorentz} resulta 
\[
