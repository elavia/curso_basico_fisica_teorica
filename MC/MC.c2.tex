...
\[
	\frac{\partial}{\partial q_l} \left( \dtot{\vb{x}_i}{t} \right) =
	\dpar{\vb{v}_i}{q_l} = \sum_{j=1}^{3N-k} \dparcru{\vb{x}_i}{q_j}{q_l} \dot{q}_j + 
...
\[
	...
	\frac{d}{dt} \left( m_i \vb{v}_i \dpar{\vb{x}_i}{q_j} \right) - 
...
\[
	\sum_i^N \dot{\vb{P}}_i \cdot \delta \vb{x}_i = 
	\sum_{j=1}^{3N-k} \sum_i^N \vb{F}_i^a \cdot \dpar{\vb{x}_i}{q_j} \delta q_j =  
