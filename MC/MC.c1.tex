...
\[
	\int \left[ \frac{2E}{m}  - \frac{kx^2}{m} - \frac{a}{mx^2} \right]^{1/2} dx = \int \; dt.
\]

La existencia de solución cerrada para esta integral dependerá, por supuesto, de la forma del potencial $V(x)$.
En este caso particular un reemplazo $ u = x^2 $ permite, luego de completar cuadrados arribar a una integral del
tipo 
\[
