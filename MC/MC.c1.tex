...
\notamargen{Poner la cuenta genérica en las notas. Why not?}
...
En este caso particular un reemplazo $ u = x^2 $ conduce, resolviendo la cuadrática resultante, a una integral del tipo 
\[
	\int \frac{1}{\sqrt{C^2 - y^2}} \; dy
\]
donde $C = \sqrt{E^2 - ka}/k $ es una constante y la variable de integración es $ y =  U - E/k $.


\notamargen{Completar esta solución. Ver en práctica?}


\notamargen{\\ Lo de $E=E(a)$ no lo entendí.}
